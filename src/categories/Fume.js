...
const headline = Categories[4].headline;

const Fume = () => (
  <Fade bottom delay={700}>
    <Helmet>
      <title>{Categories[4].headline}</title>
      <meta name="description" content={Categories[4].headline} />
    </Helmet>
    <div className="container__margin">
      <div className="heading">
        <h1 className="title">{Categories[4].headline}</h1>
      </div>
