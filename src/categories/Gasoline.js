...
const Gasoline = () => {
	...
	if (cards !== undefined && cards.length !== 0) {
		filteredCards = cards.Catalog.filter(cards => {
			return cards.category === "Рукава для бензина и минеральных масел";
		});
	}
	...
	return (
		<Fade bottom delay={700}>
			<Helmet>
				<title>Рукава для бензина и минеральных масел</title>
				<meta name="description" content="Рукава для бензина и минеральных масел" />
			</Helmet>
			<div className="container__margin">
				<div className="heading">
					<h1 className="title">Рукава для бензина и минеральных масел</h1>
				</div>
