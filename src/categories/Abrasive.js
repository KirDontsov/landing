...
const headline = Categories[6].headline;

const Abrasive = () => (
  <Fade bottom delay={700}>
    <Helmet>
      <title>{Categories[6].headline}</title>
      <meta name="description" content={Categories[6].headline} />
    </Helmet>
    <div className="container__margin">
      <div className="heading">
        <h1 className="title">{Categories[6].headline}</h1>
      </div>
