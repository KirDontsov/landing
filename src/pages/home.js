	...
	render() {
		...
		return (
			<div className="container__margin home">
					...
					<div className="heading">
						<div className="hero__banner">
							<div className="center">
								<h1 className="title main">Большой выбор рукавов по приемлемым ценам</h1>
								<div className="colWrapper">
									<div className="colMain">
										<div className="col">
											...
											<p className="text">Качество соответствует международным и отечественным стандартам</p>
										</div>
										<div className="col">
											<h2 className="white">Склад</h2>
											<p className="text">Широкий ассортимент продукции, более 62 километров в наличии на складе</p>
											<h2 className="white">Доставка</h2>
											<p className="text">Доставка во все регионы россии, круглосуточная отправка продукции</p>
										</div>
									</div>
									<div className="colMain">
				...
				{!isMobile ? <Categories categories={slideData} /> : <CategoriesMob categories={slideData} />}
				<Quiz />
			</div>
		);
	}
