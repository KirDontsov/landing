      ...
      <div className="container">
        <Fade bottom delay={900}>
          <div className="about">
            ...
            направленность компании - обеспечение предприятий
            машиностроительной, горнодобывающей, нефтегазовой, угольной,
            строительной и сельского хозяйства изделиями из резины, полиуретана,
            фторопласта, асбеста и другой сопутствующей продукцией.
          </div>
        </Fade>
