      ...
      <div className="center col">
        <Fade bottom>
          ...
          <p className="text benefits">
            Их нет. Мы обычная компания, которая сама ищет производителей РТИ в
            разных странах договаривается о сотрудничестве, закупает продукцию в
            большом объеме, привозит на свой склад в г. Екатеринбург и продает
            вам, стараясь доставить в срок.
          </p>
        </Fade>
        <Fade bottom cascade>
          <div className="benefits">
            ...
            <div className="col">
              ...
              <p className="text">
                Их нет, мы заранее договорились с производителем о самых низких
                ценах.
              </p>
            </div>
            <div className="col">
